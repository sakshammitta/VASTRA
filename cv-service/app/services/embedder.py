...
_SUBTYPE_TO_CATEGORY: dict[str, ClothingCategory] = {
    ...
    "sandals": ClothingCategory.FOOTWEAR,
    "slides": ClothingCategory.FOOTWEAR,
    "loafers": ClothingCategory.FOOTWEAR,
    "heels": ClothingCategory.FOOTWEAR,
    "formal shoes": ClothingCategory.FOOTWEAR,
    "running shoes": ClothingCategory.FOOTWEAR,
    "clogs": ClothingCategory.FOOTWEAR,
