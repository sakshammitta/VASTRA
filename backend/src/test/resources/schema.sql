...
--
-- The VECTOR domain alias lets H2 accept "CAST(? AS vector)" generated by
-- @ColumnTransformer on the embedding fields; H2 treats it as a VARCHAR cast.
CREATE DOMAIN IF NOT EXISTS VECTOR AS VARCHAR(2048);
